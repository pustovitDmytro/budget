---
geometry: "left=1cm,right=0.25cm,top=0cm,bottom=0cm"
output:
  beamer_presentation:
    toc: true
    slide_level: 2
...
:::::: {.column width="50%" data-latex="{0.5\textwidth}"}
```{r, echo=FALSE, results='asis'}
xt <- xtable(hold_total[, paste0('uah_', currencies)])
names(xt) <- currencies
...
```{r, echo = FALSE, results = 'asis'}
print(xtable(hold_total[, holdingTypes]), scalebox='0.5', comment=FALSE, sanitize.colnames.function=bold, sanitize.rownames.function=bold)
```
